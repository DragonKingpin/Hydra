...
public class GenericFormationPage implements FormationPage {
    ...
    public String getPageStatus() { return this.mszPageStatus; }
    public void setPageStatus( String pageStatus ) { this.mszPageStatus = pageStatus; }
    public long getFrameStart() { return this.mnFrameStart; }
    public void setFrameStart( long frameStart ) { this.mnFrameStart = frameStart; }
    public long getFrameEnd() { return this.mnFrameEnd; }
    public void setFrameEnd( long frameEnd ) { this.mnFrameEnd = frameEnd; }
    ...
    public void setFrames( Collection<FormationFrame> frames ) { this.mFrames = frames; }
    @Override
    public Collection<FormationFrame> frames() { return this.mFrames; }
    @Override
    public long elementSize() { return this.mnTotalCount; }
}
