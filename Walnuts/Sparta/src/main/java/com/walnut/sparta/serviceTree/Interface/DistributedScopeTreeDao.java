...
//
//public interface DistributedScopeTreeDao extends Pinenut {
//    //Node节点的CRUD
//    void saveNode(GUIDDistributedScopeNode node);
//    GUIDDistributedScopeNode selectNode(String UUID);
...
//    List<GUIDDistributedScopeNode> selectChildNode(@Param("UUID") String UUID);
