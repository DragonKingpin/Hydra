...
public class TaskChildDto implements Pinenut {
    ...
    // 构造函数保留parentPath但不映射
    public TaskChildDto(String name, String taskType, String imagePath, String resourceType,
    ...
    // 从实体转换的方法 - 不包含parentPath
    public static TaskChildDto from(GenericTaskElement element) {
        TaskChildDto dto = new TaskChildDto();
