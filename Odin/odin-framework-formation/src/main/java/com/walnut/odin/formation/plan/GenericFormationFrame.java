...
public class GenericFormationFrame implements FormationFrame {
    ...
    public void setFrameNo( long frameNo ) {
        this.mnFrameNo = frameNo;
    }

    public String getQueueType() {
        return this.mszQueueType;
    }

    public void setQueueType( String queueType ) {
        this.mszQueueType = queueType;
    }

    public String getFrameStatus() {
        return this.mszFrameStatus;
    }

    public void setFrameStatus( String frameStatus ) {
        this.mszFrameStatus = frameStatus;
    }
    ...
    public GUID getClaimToken() {
        return this.mClaimToken;
    }

    public void setClaimToken( GUID claimToken ) {
        this.mClaimToken = claimToken;
    }
    ...
    public void setLeaseExpireTime( LocalDateTime leaseExpireTime ) {
        this.mLeaseExpireTime = leaseExpireTime;
    }
    ...
    public int getAttemptCount() {
        return this.mnAttemptCount;
    }

    public void setAttemptCount( int attemptCount ) {
        this.mnAttemptCount = attemptCount;
    }

    public String getErrorCause() {
        return this.mszErrorCause;
    }

    public void setErrorCause( String errorCause ) {
        this.mszErrorCause = errorCause;
    }
}
