...
public class PhysicalHostElementOperator extends ArchElementOperator implements ElementOperator{
    ...
    public PhysicalHostElementOperator( DeviceMasterManipulator masterManipulator, DeviceInstrument deviceInstrument ){
    ...
    public PhysicalHostElement get(GUID guid ) {
        ...
        PhysicalHostElement physicalHostElement   = this.physicalHostManipulator.getPhysicalHostElement( guid, this.deviceInstrument);
