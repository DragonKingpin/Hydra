...
public class ServiceNamespaceOperator extends ArchServiceOperator implements ServiceOperator{
    ...
    public ServiceNamespaceOperator(ServiceMasterManipulator masterManipulator, ServicesTree servicesTree){
    ...
    public GUID insert(TreeNode nodeWideData) {
        ...
        GenericNodeCommonData metadata = namespaceInformation.getAttributes();
        if ( metadata != null ){
    ...
    public void purge(GUID guid) {
        ...
        if ( node.getType().getObjectName().equals(GenericNamespace.class.getName()) ||  node.getType().getObjectName().equals(GenericApplicationNode.class.getName())){
            ...
            if( metaType == null ) {
                TreeNode newInstance = (TreeNode)uoi.newInstance( new Class<? >[]{ ServicesTree.class }, this.servicesTree );
    ...
    public ServiceTreeNode get(GUID guid ) {
        ...
        GenericNodeCommonData nodeAttributes = this.attributeManipulator.getNodeMetadata(node.getNodeMetadataGUID());
        GenericNamespaceRules namespaceRules = this.namespaceRulesManipulator.getClassifRules(node.getAttributesGUID());
        ...
        genericClassificationNode.setName(this.namespaceManipulator.getClassifNode(guid).getName());
    ...
    private void removeNode( GUID guid ){
        ...
        this.attributeManipulator.remove( node.getAttributesGUID() );
    }
}
