...
public abstract class ArchConnection implements Connectson {
    protected ArchControlDispatcher mDispatcher;
    ...
    public ArchConnection( ArchControlDispatcher dispatcher ) {
        this.mDispatcher       = dispatcher;
        this.mHostSystem       = this.mDispatcher.getHostSystem();
        this.mHttpEntityParser = this.mDispatcher.getHttpEntityParser();
    }

    protected ArchConnection( ArchControlDispatcher dispatcher, Connectiom connectiom ) {
        this( dispatcher );
