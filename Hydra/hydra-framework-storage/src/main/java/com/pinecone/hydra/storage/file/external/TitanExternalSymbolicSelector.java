...
public class TitanExternalSymbolicSelector extends ReparseLinkSelector implements ExternalSymbolicSelector {
    protected ExternalSymbolicManipulator mExternalSymbolicManipulator;

    public TitanExternalSymbolicSelector( MultiFolderPathSelector pathSelector ) {
        super( pathSelector );
    }

    public TitanExternalSymbolicSelector(
