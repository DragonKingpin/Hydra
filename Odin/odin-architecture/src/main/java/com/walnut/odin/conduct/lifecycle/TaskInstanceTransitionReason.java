...
public enum TaskInstanceTransitionReason implements Pinenut {
    ...
    ResourceWait     ( InstanceEventType.DepartureReady.getName()       ),
    ProcessCreationClaim  ( InstanceEventType.DepartureReady.getName()  ),
    ProcessCreationRecovered ( InstanceEventType.DepartureReady.getName() ),
    InstantaneousBypass ( InstanceEventType.DepartureReady.getName()    ),
