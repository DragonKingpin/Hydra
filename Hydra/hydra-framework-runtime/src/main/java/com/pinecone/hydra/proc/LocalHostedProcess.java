...
public class LocalHostedProcess extends ArchUProcess implements LocalUProcess {
    public LocalHostedProcess(
            ...
            UProcess parent, ProcessManager processManager, ExecutionImage image, EntryPointRunnable entryPoint, ProcSpace procSpace,
            Map<String, String> startupArgs, Map<String, String> environmentVars
    ) {
        super( localSystemProc, guid, szName, parent, processManager, image, entryPoint, procSpace, startupArgs, environmentVars );
    }
    ...
    public LocalHostedProcess(
        ...
        this( localSystemProc, processManager.getGuidAllocator().nextGUID(), image.getName(), parent, processManager, image, entryPoint, procSpace, startupArgs, environmentVars );
    }
