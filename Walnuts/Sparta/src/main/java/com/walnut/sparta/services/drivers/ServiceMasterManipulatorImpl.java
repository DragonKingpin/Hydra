...
import com.pinecone.hydra.service.ibatis.ServiceNamespaceRulesMapper;
import com.pinecone.hydra.service.ibatis.ServiceServiceAttributeMapper;
...
public class ServiceMasterManipulatorImpl implements ServiceMasterManipulator {
    ...
    @Resource
    @Structure(type = ServiceServiceAttributeMapper.class)
    private ServiceAttributeManipulator serviceAttributeManipulator;
    ...
    @Resource
    @Structure(type = ServiceNamespaceRulesMapper.class)
    ...
    @Override
    public ServiceAttributeManipulator getAttributeManipulator() {
        return this.serviceAttributeManipulator;
    }
