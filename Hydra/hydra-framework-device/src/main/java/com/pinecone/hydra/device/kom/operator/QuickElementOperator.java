...
public class QuickElementOperator extends ArchElementOperator implements ElementOperator{
    ...
    public QuickElementOperator( DeviceMasterManipulator masterManipulator, DeviceInstrument deviceInstrument ){
    ...
    public QuickElement get(GUID guid ) {
        ...
        QuickElement quickElement   = this.quickElementManipulator.getQuickElement( guid, this.deviceInstrument);
