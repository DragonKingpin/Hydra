...
public class GenericContainerElement extends ArchElementNode implements ContainerElement{
    ...
    public GenericContainerElement(DeviceInstrument deviceInstrument, ContainerElementManipulator containerElementManipulator) {
        super(deviceInstrument);
        this.ContainerElementManipulator = containerElementManipulator;
    }

    public GenericContainerElement( Map<String, Object > joEntity, DeviceInstrument deviceInstrument ) {
    ...
    public GenericContainerElement( DeviceInstrument deviceInstrument ) {
        super(deviceInstrument);
    }
