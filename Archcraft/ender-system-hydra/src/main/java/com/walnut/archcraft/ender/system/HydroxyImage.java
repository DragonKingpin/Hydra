...
import com.pinecone.hydra.proc.image.EntryPointRunnableFactory;
...
public class HydroxyImage extends GenericClassImage {
    ...
    public HydroxyImage(
            HydraEmpire system, String name, EntryPointRunnableFactory entryPointFactory, Class<? extends UProcess> processClassType, ImageLoader imageLoader
    ) throws ImageLoadProcedureException {
        super(
                name, entryPointFactory, processClassType, imageLoader
        );
    }
