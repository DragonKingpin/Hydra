...
**Hydra的使命即让少数人（甚至一个人）即可像使用普通操作系统一样操纵大型集群阵列和超级计算机**，为你带来无限可能和强大力量，让"中二"落地。

Hydra为你打造一人即可操控的个人PB级数仓、知识库、图库、混合云中台和搜索引擎，你的专属'上帝之眼'，一切数据为所欲为！

不会集群？不会中间件？不会分布式？不会云计算？我是小白？Don`t worry，持续更新的保姆级教程和实例最小系统，弹性系统可大可小。
